...
# Visualization: Most Popular Car Models
...
# Visualization: Transmission Type Distribution
...
# Visualization: Mileage vs Price
if 'mileage' in data.columns and 'price' in data.columns:
    st.subheader("📏 Mileage vs Price")
    data['price_in_lakhs'] = data['price'] / 100_000
    filtered_data = data[(data['price_in_lakhs'] <= 300) & (data['price_in_lakhs'] >= 1)]
...
# Visualization: Car Availability Trends Over Years
...
# Visualization: Most Common Car Colors
...
# Visualization: Average Price by Year
...
# Visualization: Most Common Cities for Cars
if 'city' in data.columns:
    st.subheader("🏩 Most Common Cities for Cars")
